...
%% male
Inhal_int_m=(a_m.*a_m_t*nint(1)/ntotal(1)+b_m.*b_m_t*nint(2)/ntotal(2)+c_m.*c_m_t*nint(3)/ntotal(3)+d_m.*d_m_t*nint(4)/ntotal(4))./...
(a_m_t*nint(1)/ntotal(1)+b_m_t*nint(2)/ntotal(2)+c_m_t*nint(3)/ntotal(3)+d_m_t*nint(4)/ntotal(4));

Inhal_out_m=(a_m.*a_m_t*nout(1)/ntotal(1)+b_m.*b_m_t*nout(2)/ntotal(2)+c_m.*c_m_t*nout(3)/ntotal(3)+d_m.*d_m_t*nout(4)/ntotal(4))./...
(a_m_t*nout(1)/ntotal(1)+b_m_t*nout(2)/ntotal(2)+c_m_t*nout(3)/ntotal(3)+d_m_t*nout(4)/ntotal(4));
...
%% female
Inhal_int_f=(a_f.*a_f_t*nint(1)/ntotal(1)+b_f.*b_f_t*nint(2)/ntotal(2)+c_f.*c_f_t*nint(3)/ntotal(3)+d_f.*d_f_t*nint(4)/ntotal(4))./...
(a_f_t*nint(1)/ntotal(1)+b_f_t*nint(2)/ntotal(2)+c_f_t*nint(3)/ntotal(3)+d_f_t*nint(4)/ntotal(4));

Inhal_out_f=(a_f.*a_f_t*nout(1)/ntotal(1)+b_f.*b_f_t*nout(2)/ntotal(2)+c_f.*c_f_t*nout(3)/ntotal(3)+d_f.*d_f_t*nout(4)/ntotal(4))./...
(a_f_t*nout(1)/ntotal(1)+b_f_t*nout(2)/ntotal(2)+c_f_t*nout(3)/ntotal(3)+d_f_t*nout(4)/ntotal(4));
