...
load('D:\Thesis\codeNSC_MorrisOAT.matcl');
LabelNum=1:18;
%%
...
text(NSCMean_Inha(i,:),NSCStd_Inha(i,:),cellstr(num2str(LabelNum')),'Color','b','FontSize',10);
hold off;
subplot(2,2,2)
...
hold off;
subplot(2,2,4)
plot(NSCMean_Total(i,:),NSCStd_Total(i,:),'ks');hold on;
axis([-0.1 0.4, 0.2 0.8]);
