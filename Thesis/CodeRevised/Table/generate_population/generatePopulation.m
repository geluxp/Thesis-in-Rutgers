...
tot_inhal  = cell2mat(total_inhaled_sampler(census_age_gend)); % m^3/day
bod_weight = cell2mat(body_weight_sampler(census_age_gend)); % kg
out_frac   = cell2mat(outdoor_time_sampler(census_age_gend));
inh_per_kg_out = tot_inhal ./ bod_weight .* out_frac; % m^3/day-kg
inh_per_kg_in = tot_inhal ./ bod_weight .* (1-out_frac); % m^3/day-kg
